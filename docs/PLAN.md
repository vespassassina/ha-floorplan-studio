...
### S3.3 Pickers from hass (built 2026-09-21: `haData`, device entity picker, unbound marker and list; tests green; the live check on Diego's HA is open. Not built: hide placed entities, rebuild the catalog on Save)
